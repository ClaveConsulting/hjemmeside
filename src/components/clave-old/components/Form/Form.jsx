		...
		return (
			<form name="message" method="POST" data-netlify="true">
				...
				<CustomInput
					name="navn"
					className={
						this.state.nameIsChanged && !this.state.nameValid ? "error" : ""
					}
				...
				<CustomInput
					name="Epost"
					className={
						this.state.emailIsChanged && !this.state.emailValid ? "error" : ""
					}
				...
				<CustomInput
					name="Melding"
					className={
						this.state.messageIsChanged && !this.state.messageValid
							? "error"
							: ""
					}
