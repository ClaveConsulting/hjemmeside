...
const ProjectPage = () => {
	return (
		...
		>
			<div>
				<p>
					Vi har vært mange Clavere hos Komplett gjennom flere år. Sammen har vi
					blant annet skapt nye betalingsløsninger, ny navigasjon, ny
					“pc-bygger” og et nytt apotek.
				</p>
				<p>
					De tverrfaglige teamene vi har jobbet i har bestått av både utviklere,
					UX-designere og testere fra Komplett, Clave og datterselskapet vårt
					Fabres. Vi har hele tiden hatt et tett samarbeid med forretningssiden
					hos Komplett og sånn har vi klart å sikre at vi alltid går i samme
					retning som kundens ambisjoner.
				</p>
				<p>
					Komplett er modige. De ser muligheter og kaster seg inn i nye
					markeder. Vår reise sammen med dem har derfor vært veldig spennende -
					fra å utvikle det vi alle håpet skulle være riktig har vi beveget oss
					til alltid å lytte til kundene til Komplett når vi har utviklet noe
					nytt. Gjennom dialog, brukertesting og samarbeid med kundeservice er
					vi stolte av å ha laget produkter som kundene syns er enkle å bruke og
