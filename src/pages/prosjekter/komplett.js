      ...
      <ProjectPageTemplate
        ...
        body={
          <TextComponentWrapper>
            ...
            <Paragraph>
              Teamene i Komplett bestod av UX'ere, utviklere og testere fra både
              Komplett, Clave og det Polske selskapet Fabres. I tillegg var
              alltid forretning med i prosessen. Vi møttes selvfølgelig av og
              til, men utviklet også et skikkelig godt forhold ved å se og
              snakke med hverandre via video hver dag. Ved å jobbe i
              tverrfaglige team, på tvers av landegrensene, har vi lært hva som
              er viktigst for at samarbeidet skal fungere aller best.{' '}
            </Paragraph>

            <Paragraph>
              Komplett er modige. De ser muligheter og kaster seg inn i nye
              markeder. Reisen med Komplett har vært spennende. - Fra å utvikle
              det alle håpet var riktig, til å faktisk lytte til brukeren i alt
              som utvikles. Alltid. Vi inviterte brukeren til dialog,
              brukertestet det vi lagde og samarbeidet tett med kundeservice.
              Fail fast, men snakk med brukeren først!
            </Paragraph>
          </TextComponentWrapper>
        }
        keywords={[
